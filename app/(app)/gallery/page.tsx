...
export default function Gallery() {
  ...
  return (
    <div className="relative w-full bg-black">
      ...
      <div className="flex min-h-screen flex-col  items-center justify-center pt-20 md:!pt-28">
        <div className="mb-10 mt-6 flex flex-col items-center justify-center px-20">
          <CustomGradualSpacing
            className="font-display text-center text-[27px] font-black md:!text-6xl md:leading-[5rem]"
          ...
          <div className="mt-3 px-10 md:!px-40">
            <p className="text-center text-sm leading-none text-gray-400 md:!text-xl">
              The next Blue chip on Internet, powered by{' '}
              <Link href="https://www.stargaze.zone" className="text-[#DB2877]">
                Stargaze.
              </Link>
            </p>
          </div>
        ...
        <Marquee speed={100}>
          {[...collections, ...collections].map((item, index) => (
            <div key={index} className="flex items-center justify-center">
              <CollectionCard key={index} data={item} index={index} />
            </div>
          ))}
        </Marquee>
      ...
      <div className="h-full bg-[url('/images/bg-line-grid.png')] bg-cover bg-center py-16">
