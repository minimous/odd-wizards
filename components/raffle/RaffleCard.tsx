  ...
  const renderParticipants = () => {
    return (
      <div className="flex h-full flex-col">
        <div
          className={cn(
            'px-42 flex items-center gap-2 p-2 text-sm',
        ...
        <div className="border-t-2 border-[#323237] px-4 py-2">
          {data?.rewards?.[0] && (
            <Link
          ...
          <div className="py-2">
            <span className="mx-2 my-2 opacity-50">Raffle Participants</span>
            <ScrollArea className="h-[380px] flex-1 overflow-y-auto px-2">
              {Object.values(summedParticipants)?.map((item, index) => (
                <div
                  key={index}
                  className="my-2 flex items-center justify-between text-lg"
                >
                  <Link
    ...
    <div className="relative">
      ...
      >
        ...
        >
          ...
          <div
            className={cn(
              'absolute h-full w-full',
              'rounded-[20px] border-2 border-[#323237] bg-[#18181B]',
              '[backface-visibility:hidden]'
            )}
          >
            <MagicCard className="h-full w-full" gradientColor={'#262626'}>
              <div
                className={cn(
              ...
              <div className="h-full border-t-2 border-[#323237] p-2 px-6">
                {data?.rewards?.[0] && (
                  <Link
                    href={`https://www.stargaze.zone/m/${raffle.rewards[0].reward_collection}/${raffle.rewards[0].reward_token_id}`}
                  >
      ...
      >
        <Button
          ...
          variant="ghost"
          className="gap-x-2 italic opacity-50 hover:bg-transparent hover:opacity-60"
        >
          <Eye size={20} />
