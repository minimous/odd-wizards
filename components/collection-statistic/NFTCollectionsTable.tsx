...
import { useMarketplaceCollections, useMarketplacePagination } from '@/hooks/useFilterCollection';
                ...
                <table className="w-full">
                    ...
                    <tbody>
                        ...
                        {collections.length > 0 && (
                            <>
                                {collections.map((collection: FormattedCollection, index: number) => (
                                    <TableRow
                            ...
                            <tr>
                                <td colSpan={7} className="py-4 text-center">
                                    <button
                                        ...
                                        className="text-sm text-[#857F94] hover:text-white cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
