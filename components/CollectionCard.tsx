...
const CollectionCard = ({ data }: CollectionCardProps) => {
    ...
    return (
        <div className="flex flex-col items-center bg-black text-white border border-white group w-[300px] h-[425px]">
            <div className="relative flex justify-center items-center w-[300px] h-[300px] overflow-hidden">
